...
#'
#' Landsat4TM         -> 1,2,3,4,5,7     (blue,green,red,nir,swir1,swir2)
#' Landsat5TM         -> 1,2,3,4,5,7     (blue,green,red,nir,swir1,swir2)
#' Landsat7ETM+       -> 1,2,3,4,5,7     (blue,green,red,nir,swir1,swir2)
#' Landsat8OLI        -> 2,3,4,5,6,7     (blue,green,red,nir,swir1,swir2)
#' Landsat8OLI-Li2016 -> 1,2,3,4,5,6,7   (coastal,blue,green,red,nir,swir1,swir2)
